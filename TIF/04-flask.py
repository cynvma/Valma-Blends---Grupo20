...
catalogo = Catalogo(host='cynvma.mysql.pythonanywhere-services.com', user='cynvma', password='valmablends10', database='cynvma$miapp')

# Carpeta para guardar las imagenes
#ruta_destino = 'static/imagenes/'
ruta_destino = '/home/cynvma/mysite/static/imagenes/'
